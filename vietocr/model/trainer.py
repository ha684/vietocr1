...
class Trainer():
    def __init__(self, config, pretrained=False, augmentor=ImgAugTransformV2()):
        ...
        self.train_gen = self.data_gen('/kaggle/input/images1/train_{}'.format(self.dataset_name), 
                self.data_root, self.train_annotation, self.masked_language_model, transform=transforms)
        if self.valid_annotation:
            self.valid_gen = self.data_gen('/kaggle/input/images1/valid_{}'.format(self.dataset_name), 
